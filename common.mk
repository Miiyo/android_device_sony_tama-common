...
# Dolby
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/dolby/moto-dax-default.xml:$(TARGET_COPY_OUT_VENDOR)/etc/dolby/dax-default.xml
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/nfc/init.tama_kddi.nfc.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.tama_kddi.nfc.rc
